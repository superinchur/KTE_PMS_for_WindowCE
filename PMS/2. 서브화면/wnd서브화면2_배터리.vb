Public Class wnd서브화면2_배터리
    ...
    Public Sub New()
        ...
        BMS타이머_상태.Interval = 1000
        BMS타이머_상태.Enabled = True
    ...
    Private Sub 타이머_상태_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BMS타이머_상태.Tick

        BMS타이머_상태.Enabled = False
